  ...
  return (
    <div className="w-full p-6 flex flex-col ">
      <a className="hover:shadow-lg p-2 ">
        ...
        <Link href={{ pathname: '/detailsProducts/[slug]', query: { slug: data?.slug } }}>
          <button
            className='p-1 m-1 rounded-sm text-white text-center bg-violet-500 drop-shadow hover:bg-violet-600 active:bg-violet-700 focus:ring focus:ring-violet-300'
            type="button">
            جزئیات بیشتر ...
          </button>
        </Link>
