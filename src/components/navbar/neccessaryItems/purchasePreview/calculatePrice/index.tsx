...
const CalculatePrice: React.FC = () => {
    ...
    return (
        <div className="p-3">
            ...
            <div className="mt-8">
            <Link href={'/cart'}>
                <a className="transition-all p-3  rounded text-white text-center bg-violet-500 font-bold drop-shadow hover:bg-violet-600 active:bg-violet-700 focus:ring focus:ring-violet-300  mx-1">
                    ثبت سفارش
                </a>
            </Link>
            </div>
